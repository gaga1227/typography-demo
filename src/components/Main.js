  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <h3>Overview</h3>
        <p>
          Creative Designer/Developer with more than 17 years of experience from
          digital agency, in-house and corporate environments in both Australia
          and China.
        </p>
        <p>
        ...
        <p>
          ...
          in working on UI/UX engineering, responsive web design and mobile/web
          applications with edge technologies.
        </p>
        <h3>Contact</h3>
